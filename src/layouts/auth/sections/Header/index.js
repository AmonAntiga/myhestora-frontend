...
import logoCT from "assets/images/pages/auth/header/hestora-logo-dark.png";
...
// Default Sedtions Constructors
import DefaultNavbarDropdown from "layouts/auth/sections/Header/Navbars/DefaultNavbar/DefaultNavbarDropdown";
import DefaultNavbarMobile from "layouts/auth/sections/Header/Navbars/DefaultNavbar/DefaultNavbarMobile";
        ...
        <MKBox display="flex" justifyContent="space-between" alignItems="center">
          ...
          >
            <MKTypography variant="button" fontWeight="bold" color={light ? "white" : "dark"}>
              <MKBox component="img" src={logoCT} alt={brand} maxWidth="100px" mt={1} />
            </MKTypography>
          </MKBox>
          <MKBox
            color="inherit"
          ...
          <MKBox display="flex" ml={{ xs: "auto", lg: 0 }} gap={1}>
            <MKButton
              component="a"
              href={""}
              target="_blank"
